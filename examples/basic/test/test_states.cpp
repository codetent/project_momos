...
{
    LOG("Description: SEND_TIMESTAMP: Timeout matches expected value.");
...
{
    LOG("Description: RECEIVE_TIMESTAMP: Timeout matches expected value.");
    ...
    // [Step 5]: RECEIVE_TIMESTAMP: Timeout matches expected value. ----------
